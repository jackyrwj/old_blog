...
> - “零” ：表示次数为0，它表示拷贝数据的次数为0。 合起来，那**零拷贝**就是不需要将数据从一个存储区域复制到另一个存储区域咯。
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/cf25598e718b45d9966ce5afc0128d94~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp)
